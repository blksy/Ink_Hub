...
class PortfolioItemCreateViewTests(TestCase):
    def setUp(self):
        ...
        self.url = reverse("artists:portfolio-item-create")
    ...
    def test_artist_can_access_portfolio_create_view(self):
    ...
    def test_artist_can_create_portfolio_item(self):
    ...
    def test_artist_can_create_portfolio_item_with_styles(self):
